// Linkedlist data taken from string
...
int main()
{
	...
	char myData[] = "1001,Chaitali Ahire,5234.4234:1002,Divya Ahire,5235.523:1003,Ranjana Ahire,5234.235:1004,Dinkar Ahire,5234.523:1005,Radhika kadam,523523.42";
	Node *first = NULL;
